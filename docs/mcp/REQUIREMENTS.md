...
Earlier rows/notes below describe intermediate evidence where not yet updated.
...
| `lomi_workspace_update`      | 03 / 07 / P5.3  | Closed rename/select/close DTOs; per-action scopes, exact revision and durable ancestor receipts                                                                                                                                        | UDS/native56 YWPPVZ; six real runtime close cycles, dirty-buffer guards                                                                      | IN_PROGRESS — Android descendants pending; plugins excluded         |
...
| `lomi_panel_move`            | 03 / 07 / P5.3  | Reorder/dock/move and same-project cross-workspace tab transfer; both grants, exact resource identities                                                                                                                                 | Model/UDS/wire and native56 YWPPVZ; same PTY/form/buffer/Undo; original run retry preserved                                                  | IN_PROGRESS — Android transfer pending; plugins excluded            |
...
| `lomi_terminal_create`       | 05 / P2         | Closed control.rs DTO; broker/terminals.rs, terminal_runs.rs, terminal_input.rs; native terminal.rs and retained terminal-runtime.ts                                                                                                    | Native Bash uw9501 / Zsh Gn0P6D: 13 checks each; core, wire and UI tests                                                                     | QUALIFIED_MACOS_ARM64; P6 separate                                  |
| `lomi_terminal_run`          | 05 / P2         | Closed control.rs DTO; broker/terminals.rs, terminal_runs.rs, terminal_input.rs; native terminal.rs and retained terminal-runtime.ts                                                                                                    | Native Bash uw9501 / Zsh Gn0P6D: 13 checks each; core, wire and UI tests                                                                     | QUALIFIED_MACOS_ARM64; P6 separate                                  |
| `lomi_terminal_read`         | 05 / P2         | Closed control.rs DTO; broker/terminals.rs, terminal_runs.rs, terminal_input.rs; native terminal.rs and retained terminal-runtime.ts                                                                                                    | Native Bash uw9501 / Zsh Gn0P6D: 13 checks each; core, wire and UI tests                                                                     | QUALIFIED_MACOS_ARM64; P6 separate                                  |
| `lomi_terminal_input`        | 05 / P2         | Closed control.rs DTO; broker/terminals.rs, terminal_runs.rs, terminal_input.rs; native terminal.rs and retained terminal-runtime.ts                                                                                                    | Native Bash uw9501 / Zsh Gn0P6D: 13 checks each; core, wire and UI tests                                                                     | QUALIFIED_MACOS_ARM64; P6 separate                                  |
| `lomi_terminal_interrupt`    | 05 / P2         | Closed control.rs DTO; broker/terminals.rs, terminal_runs.rs, terminal_input.rs; native terminal.rs and retained terminal-runtime.ts                                                                                                    | Native Bash uw9501 / Zsh Gn0P6D: 13 checks each; core, wire and UI tests                                                                     | QUALIFIED_MACOS_ARM64; P6 separate                                  |
...
| `lomi_chat_list`             | 07 / P5.6       | chat.read + exact Settings-selected IDs and project binding; at most 64 metadata records                                                                                                                                                | Revision-bound pages, empty grants do not initialize private history; recheck after I/O                                                      | UDS2/native-store2 + native jMNDbu11 PASS                           |
| `lomi_chat_open`             | 07 / P5.6       | ChatOpenInput/ChatOpened; chat.read/open + panel.create/focus, new additionally chat.create                                                                                                                                             | Native one-use creation, creator-only IDs, retained standalone/mixed view, durable retry; native qVY6Fd54 includes full selected Chat layout | Core1/model2/wire5/TS + native ygmgFM17 PASS                        |
| `lomi_chat_draft`            | 07 / P5.6       | ChatDraftInput/ChatDraftUpdated; chat.read/draft + exact open panel and selected conversation                                                                                                                                           | Native CAS of text <=32 KiB, dual content revisions and domain revision; durable retry; live human typing retained; no provider dispatch     | Core1/native-store3/UI4/TS + native dtcU69 (23 total) PASS          |
| `lomi_chat_read`             | 07 / P5.6       | chat.read + exact selected conversation; persisted draft or message text                                                                                                                                                                | UTF-16/revision pages <=8192 units/48 KiB; no system prompt, keys, reasoning or attachment bytes                                             | UDS2/native-store2 + native jMNDbu11 PASS                           |
| `lomi_chat_send`             | 07 / P5.6       | chat.read/send, selected exact target, configured connection/model, three revisions and durable request IDs                                                                                                                             | Native exact-context approval before key access/provider; retained SDK and next draft; one-use commit/retry                                  | Native 3w7ndI31 and 4aNBY2 (35 total), UI14, broker regression PASS |
| `lomi_chat_stop`             | 07 / P5.6       | chat.read/stop, exact selected conversation/project and request ID; durable retry                                                                                                                                                       | Native terminal checkpoint; no renderer dependency; unknown IDs cannot register cancellation; old retry preserves newer generation           | Native 4aNBY2 (35 total), native units2, core/wire/UI PASS          |
| `lomi_chat_export`           | 07 / P5.6       | chat.read/export, exact selected conversation/project; Markdown/JSON text pages, no file writes                                                                                                                                         | All saved variants + draft; private fields omitted, 512 messages/4 MiB, scalar/revision pages <=8192 units/48 KiB; document SHA-256          | Native BxwjjV (41 total), native unit1/core Chat7/wire5/UI1/TS PASS |
